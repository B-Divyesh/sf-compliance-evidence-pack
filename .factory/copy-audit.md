...
Audited 2026-08-28 after perfection-loop round 5. Counts use displayed tokens:
...
| Copy | Words | Result |
| --- | ---: | --- |
| Sample filing-period evidence | 3 | Pass; image caption names its subject |
...
| What Deadline Packet does not do. | 6 | Pass; section heading names its scope |
...
| Pricing | 1 | Pass; section label |
| Lifetime license | 2 | Pass; section heading |
...
## Policy and error routes

| Copy | Words | Result |
| --- | ---: | --- |
| Privacy policy · 28 August 2026 | 6 | Pass; dated policy label |
| How Deadline Packet stores and sends data. | 7 | Pass; h1 names the policy scope |
| After your first visit, the browser saves the app so packet work remains available offline. | 15 | Pass; browser-facing offline result |
| Error 404 | 2 | Pass; status label |
| Page not found. | 3 | Pass; direct error h1 |
...
| Includes one complete packet and its core exports free. | 9 | Pass; covered by `free-and-paid` |
| A US$12 lifetime license adds unlimited packets and duplication. | 9 | Pass; one entitlement term |
